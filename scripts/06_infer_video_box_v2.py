...
scripts/06_infer_video_boxes_v4_zone_temporal_mysql.py
======================================================
...
from utils.evidence_manager import EvidenceManagerV2
...
OUTPUT_PATH = os.getenv(
    ...
    "runs/detect/grabacion_epp_detection_new_v12.mp4"
)
...
logger = get_logger("infer_video_epp_v4", str(LOG_DIR / "infer_video_epp_v4.log"))
...
def main() -> None:
    ...
    evidence = EvidenceManagerV2(base_path="evidence")
